...
namespace ProjekPBO_PSQL.Models
{
    ...
    {
        private decimal _skorPutih = 0.0m;
        private decimal _skorHitam = 0.0m;
        ...
        {
            return $"Match ID: {IdPertandingan} | Babak: {Babak} | User {PemainPutih} (P) vs User {PemainHitam} (H) | Skor: {SkorPutih} - {SkorHitam} | Hasil: {Hasil}";
        }
    }
}
