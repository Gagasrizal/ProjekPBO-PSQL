...
namespace ProjekPBO_PSQL.Models
{
    public abstract class AkunUser
    {
        ...
        protected AkunUser(int id, string username, string password, string email, bool isAdmin)
        {
            this.IdUser = id;
            ...
            this.Profil = new ProfilCatur();
        }

        protected AkunUser(int id, string username, string password, string email, bool isAdmin, ProfilCatur profil)
            : this(id, username, password, email, isAdmin)
        {
            this.Profil = profil ?? new ProfilCatur();
        }
